% https://www.uahirise.org/ESP_059329_2095

clear; close all; clc;

%% Set the parameters depending on the picture

%I = imread('ESP_068360_1985.jpg'); % 29.4 cm/pixel (Perseverance)
%I = imread('ESP_059329_2095_RGB.jpg'); % 29.4 cm/pixel
%I = imread('mars_surface.jpg'); % 504.38 m/pixel
%I = imread('mars_vulcanic.jpg'); % 504.38 m/pixel
I = imread('volcans-mars-hirise.jpg'); % 5.196 m/pixel

%mpp = 0.294; % meters per pixel (ESP pics)
